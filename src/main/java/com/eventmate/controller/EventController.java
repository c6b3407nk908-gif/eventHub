...
public class EventController {
    ...
    public ResponseEntity<?> createEvent(
        ...
        Event savedEvent = eventService.createEvent(eventName, category, description, eventDate, eventTime, location, jobVacancy, adsOpportunity, opportunitiesDeadline, organizerId, image);
    ...
    public ResponseEntity<?> updateEvent(
        ...
        Event updatedEvent = eventService.updateEvent(id, eventName, category, description, eventDate, eventTime, location, jobVacancy, adsOpportunity, opportunitiesDeadline, image);
    ...
    @DeleteMapping("/{id}/jobs/{roleTitle}")
    public ResponseEntity<?> removeJobOpportunity(@PathVariable String id, @PathVariable String roleTitle) {
        Event updatedEvent = eventService.removeJobOpportunity(id, roleTitle);
        return ResponseEntity.ok(updatedEvent);
    }

    @DeleteMapping("/{id}/sponsorships/{packageName}")
    public ResponseEntity<?> removeSponsorshipPackage(@PathVariable String id, @PathVariable String packageName) {
        Event updatedEvent = eventService.removeSponsorshipPackage(id, packageName);
        return ResponseEntity.ok(updatedEvent);
    }
}
