...
public class EventServiceImpl implements EventService {
    ...
    @Override
    public Event createEvent(String eventName, String category, String description, Date eventDate, String eventTime, String location, boolean jobVacancy, boolean adsOpportunity, Date opportunitiesDeadline, String organizerId, MultipartFile image) {
        try {
    ...
    @Override
    public Event updateEvent(String id, String eventName, String category, String description, Date eventDate, String eventTime, String location, boolean jobVacancy, boolean adsOpportunity, Date opportunitiesDeadline, MultipartFile image) {
    ...
    @Override
    public Event removeJobOpportunity(String eventId, String roleTitle) {
        Event event = getEventById(eventId);
        event.getJobs().removeIf(job -> job.getRoleTitle().equalsIgnoreCase(roleTitle));
        return eventRepository.save(event);
    }

    @Override
    public Event removeSponsorshipPackage(String eventId, String packageName) {
        Event event = getEventById(eventId);
        event.getSponsorships().removeIf(sponsor -> sponsor.getPackageName().equalsIgnoreCase(packageName));
        return eventRepository.save(event);
    }
}
